...
// }";
            _realShader = Shader.Load("VeroEngine.ImGui");
            _shader = _realShader.Handle;
        ...
        private void RenderImDrawData(ImDrawDataPtr draw_data)
        {
            ...
            for (int i = 0; i < draw_data.CmdListsCount; i++)
            {
                ...
                if (vertexSize > _vertexBufferSize)
                {
                    ...
                    Log.Info($"Resized dear imgui vertex buffer to new size {_vertexBufferSize}");
                }
                ...
                if (indexSize > _indexBufferSize)
                {
                    ...
                    Log.Info($"Resized dear imgui index buffer to new size {_indexBufferSize}");
                }
            }
        ...
        public static int CreateProgram(string name, string vertexSource, string fragmentSoruce)
        {
            ...
            if (success == 0)
            {
                ...
                Log.Info($"GL.LinkProgram had info log [{name}]:\n{info}");
            }
        ...
        private static int CompileShader(string name, ShaderType type, string source)
        {
            ...
            if (success == 0)
            {
                ...
                Log.Info($"GL.CompileShader for shader '{name}' [{type}] had info log:\n{info}");
            }
