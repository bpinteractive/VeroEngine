...
public class Node : IDisposable
    {
        ...
        private bool _disposed = false; // Tracks whether the node has been disposed.
        ...
        public void AddChild(Node child)
        {
            ...
            while (_children.Any(node => node.Name == child.Name))
            {
        ...
        {
            var copy = (Node)Activator.CreateInstance(this.GetType());
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposed)
            {
                if (disposing)
                {
                    ...
                    foreach (var child in new List<Node>(_children))
                    {
                        child.Dispose();
                    }
